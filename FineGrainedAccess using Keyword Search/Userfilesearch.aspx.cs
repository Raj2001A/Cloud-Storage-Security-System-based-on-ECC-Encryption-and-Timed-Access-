...
public partial class Userfilesearch : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand("select Distinct Fileid,OwerName,FileName,FileSize  from ranktb where FileName like '%" + TextBox1.Text + "%' or Keyword like '%" + TextBox1.Text + "%'", con);
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd = new SqlCommand("select * from ranktb where Fileid ='" + id+ "'", con);
        SqlDataReader dr;
        ...
        cmd = new SqlCommand("insert into userfiletb values('" + id + "','" + s2 + "','" + s3 + "','" + s4 + "','" + Session["uuname"].ToString() + "','Waiting','')", con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
