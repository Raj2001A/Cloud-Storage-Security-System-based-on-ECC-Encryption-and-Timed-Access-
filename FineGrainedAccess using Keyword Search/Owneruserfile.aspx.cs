...
public partial class Owneruserfile : System.Web.UI.Page
{
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd = new SqlCommand("update userfiletb  set Status='Approved',Keys='" + key + "' where Fileid='" + id + "' ", con);
        cmd.ExecuteNonQuery();
        con.Close();
        bind();
    ...
    private void bind()
    {
        cmd = new SqlCommand("select * from userfiletb where Status='waiting' and OwnerName='" + Session["uname"].ToString() + "'", con);
        ...
        cmd = new SqlCommand("select * from userfiletb where Status='Approved' and OwnerName='" + Session["uname"].ToString() + "' ", con);
