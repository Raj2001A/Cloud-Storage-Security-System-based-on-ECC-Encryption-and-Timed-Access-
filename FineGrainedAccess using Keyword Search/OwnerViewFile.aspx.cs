...
public partial class OwnerViewFile : System.Web.UI.Page
{
    ...
    private void bind()
    {
        cmd = new SqlCommand("select * from filetb where OwnerName='" + Session["uname"].ToString() + "'", con);
        ...
        cmd = new SqlCommand("select * from ranktb where OwerName='" + Session["uname"].ToString() + "'", con);
